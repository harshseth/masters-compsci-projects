...
public class ScanPlan extends Plan {
	...
	public String toString() {
		...
		carray[indexType[0]]='s';
		carray[indexType[1]]='p';
		carray[indexType[2]]='o';
		return getRelations().toString()+new String(carray).substring(1);
		//return ""+getScore();
