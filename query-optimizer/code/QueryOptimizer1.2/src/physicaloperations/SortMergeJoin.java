...
//		double CPUcost = innerCard + outerCard;
		...
		double sortingCPU = innerCard*Math.log10(innerCard)/Math.log10(2)+ outerCard*Math.log10(outerCard)/Math.log10(2); 
		double sortingIO =  num_pages_inner*Math.log10(num_pages_inner)/Math.log10(BUFFERSIZE)+num_pages_outer*Math.log10(num_pages_outer)/Math.log10(BUFFERSIZE);
