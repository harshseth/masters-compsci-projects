...
open(SPECHAR,"train5_nonspam") or die "cant open SPECHAR: $!";
open(TRAIN1,">train6_nonspam") or die "cant open TRAIN1: $!";
...
open(BAG,"bookmarks_per_user") or die "cant open BAG: $!";
